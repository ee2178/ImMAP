"""
sb/immap_sb_ascent.py -- the EARLIER ImMAP-SB: self-paced annealed Tweedie ascent.

Moved here from sb/immap_sb.py when that name went to the learned-DC-prox sampler (sb/immap_sb.py).
Kept importable for reference; its annealing does not reach low noise scales as written.
...
@torch.no_grad()
def immap_sb_ascent(net, y, sched, cond=None, tau=0.19, beta=0.05, t_L=0.01, h_0=0.01,
