...
def train_ipalm(
    ...
    for step in range(start_step, max_steps):
        ...
        # Generate a masked fourier transform operator
        MF = Mask(mask) @ FFT2D()
        ...
        recon, _, _ = net(
            ...
            MF=MF,
            sigma=sigma_n,
            S = smaps, # ipalmnet initialize at espirit smaps, refines them within the net. 
        )
