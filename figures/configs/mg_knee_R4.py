# knee R=4: the flat LPDS stack against the multigrid schedule.
#
...
#       --only lpdsnet_R4 mglpds_R4 --n-volumes 4 --slices 12:25
#   python figures/viewer.py figures/configs/mg_knee_R4.py -n 3
...
# The viewer writes rows/mg_knee_R4.json; seeding ROWS here would leave
